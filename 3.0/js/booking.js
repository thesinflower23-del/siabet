  ...
  const cutsHTML = cuts.map(cut => {
    ...
    return `
      <div style="text-align: center; width: 140px; flex: 0 0 140px; scroll-snap-align: start;">
        <div style="width: 140px; height: 140px; background: ${cut.backgroundColor || '#f5f5f5'}; border-radius: 1rem; margin: 0 auto 0.6rem; display: flex; align-items: center; justify-content: center; border: 3px solid ${cut.borderColor || '#ccc'}; overflow: hidden;">
          <a href="${cut.image}" class="lightbox-link">
            <img src="${cut.image}" alt="${cut.name}" style="width: 100%; height: 100%; object-fit: cover;" onerror="this.style.display='none';">
          </a>
        </div>
